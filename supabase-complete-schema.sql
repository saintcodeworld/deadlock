-- ============================================================
-- HIDE SLASHER GAME - COMPLETE SUPABASE SCHEMA
-- ============================================================
...
-- Drop existing policies to avoid conflicts on re-run
DROP POLICY IF EXISTS "Allow all to read user profiles" ON user_profiles;
DROP POLICY IF EXISTS "Allow all to insert user profiles" ON user_profiles;
DROP POLICY IF EXISTS "Allow all to update user profiles" ON user_profiles;

-- Policies: anyone can read, insert, and update
CREATE POLICY "Allow all to read user profiles"
  ON user_profiles FOR SELECT
  USING (true);

CREATE POLICY "Allow all to insert user profiles"
  ON user_profiles FOR INSERT
  WITH CHECK (true);

CREATE POLICY "Allow all to update user profiles"
...
-- DONE!
-- ============================================================
-- Your database is now ready for the HIDE game
